...
export default class Edit extends Component {
    ...
    componentDidMount() {
        this.setState({ editName: this.props.name[0].props.children, editDescription: this.props.description[0].props.children, croppedImg: this.props.image[0].props.children, country: this.props.country[0].props.children});
    }

    resetDefaults = () => {
        this.setState({ editName: "", editDescription: "", editCountry: "Canada", editProvince: "Alberta", editTags: "", active_prov: this.state.can_prov, active_prov_label: "Provinces", "editImage": "", "croppedImg": "", chars_left: max_description })
    }
    ...
    deleteNom = () => {
        if (this.props.userId != null) {
            ...
            axios.delete('https://fast-cove-41298.herokuapp.com/nominations/' + this.props.id[0].props.children, { headers, data } )
            // axios({
            //     method: 'delete',
            //     url: 'https://fast-cove-41298.herokuapp.com/nominations/' + this.props.id[0].props.children,
            //     data: bodyFormData,
            //     config: { headers: { 'Content-Type': 'multipart/form-data' }, bodyFormData }
            // })
                ...
                <Modal dialogClassName="submit_modal" show={this.state.show} onHide={this.handleClose}>
                    ...
                    <Modal.Body>
                        ...
                        <FormGroup controlId="formControlsSelect">
                            ...
                            <FormControl componentClass="select" placeholder="select" value={this.state.editCountry} onChange={this.handleCountryChange}>
                    ...
                    <Modal.Footer>
                        ...
                        <button type="button" className="btn btn-success" onClick={this.submitNom}>Update</button>
                    </Modal.Footer>
